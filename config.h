...
static const char *fonts[]          = { "JetBrains Mono:size=10:antialias=true", "Twitter Color Emoji:pixelsize=10:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true" };
