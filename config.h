...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10:antialias=true", "Twitter Color Emoji:pixelsize=10:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true" };
